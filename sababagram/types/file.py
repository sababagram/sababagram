...
class File(BaseTelegramType):
    ...
    a new one can be requested by calling :func:`sababagram.methods.get_file`.
    ...
    *Optional*. File size in bytes. 
    ...
    """
    *Optional*. File path. 
    Use :code:`https://api.telegram.org/file/bot<token>/<file_path>` to get the file.
    """
