...
class Chat(BaseTelegramType):
    ...
    *Optional*. Last name of the other party in a private chat
    ...
    """
    *Optional*. *True*, 
    if the supergroup chat is a forum (has `topics 
    <https://telegram.org/blog/topics-in-groups-collectible-usernames#topics-in-groups>`_ enabled)
    """
    ...
    *Optional*. If non-empty, 
    ...
    <https://telegram.org/blog/topics-in-groups-collectible-usernames#collectible-usernames>`_; 
    for private chats, supergroups and channels. Returned only in :func:`sababagram.methods.get_chat`.
    """
