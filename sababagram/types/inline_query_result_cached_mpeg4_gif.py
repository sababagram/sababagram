...
class InlineQueryResultCachedMpeg4Gif(InlineQueryResult):
    ...
    Telegram servers. By default,
    this animated MPEG-4 file will be sent by the user with an optional caption. Alternatively,
    ...
    type: str = field(default="mpeg4_gif", init=False)
    """
