...
from . import File, MaskPosition, PhotoSize
...
class Sticker(BaseTelegramType):
    ...
    is_animated: bool
    """
    *True*, if the sticker is `animated <https://telegram.org/blog/animated-stickers>`_
    """
    is_video: bool
    """
    *True*, 
    if the sticker is a `video sticker <https://telegram.org/blog/video-stickers-better-reactions>`_
    """
